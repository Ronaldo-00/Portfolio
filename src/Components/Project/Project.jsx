...
const Project = () => {
  ...
  const project1 = useProjectInView();
  const project2 = useProjectInView();
  const project3 = useProjectInView();
  const project4 = useProjectInView();
  const project5 = useProjectInView();
  const project6 = useProjectInView();
  const project7 = useProjectInView();
        ...
        <div className="project-container">
            ...
            <div className="project-content">
                ...
                <motion.div
                  ...
                  ref={project1.ref} // Track visibility
                  initial="hidden"
                  animate={project1.controls} // Animate based on visibility
                >
                ...
                <motion.div
                  ...
                  ref={project2.ref} // Track visibility
                  initial="hidden"
                  animate={project2.controls} // Animate based on visibility
                >
                ...
                <motion.div
                  className="project-row"
                  variants={VariantsLeft}
                  ref={project3.ref} // Track visibility
                  initial="hidden"
                  animate={project3.controls} // Animate based on visibility
                >
                  <div className="project-col-1 ">
                ...
                <motion.div
                  className="project-row"
                  variants={VariantsRight}
                  ref={project4.ref} // Track visibility
                  initial="hidden"
                  animate={project4.controls} // Animate based on visibility
                >
                  <div className="project-col-1 order-right">
                ...
                <motion.div 
                  className="project-row"
                  variants={VariantsLeft}
                  ref={project5.ref} // Track visibility
                  initial="hidden"
                  animate={project5.controls} // Animate based on visibility
                >
                  <div className="project-col-1 ">
                 ...
                 <motion.div
                  className="project-row"
                  variants={VariantsRight}
                  ref={project6.ref} // Track visibility
                  initial="hidden"
                  animate={project6.controls} // Animate based on visibility
                 >
                  <div className="project-col-1 order-right ">
                ...
                <motion.div 
                  className="project-row"
                  variants={VariantsLeft}
                  ref={project7.ref} // Track visibility
                  initial="hidden"
                  animate={project7.controls} // Animate based on visibility
                >
                  <div className="project-col-1 ">
